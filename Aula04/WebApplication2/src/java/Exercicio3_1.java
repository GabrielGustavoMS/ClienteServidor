...
public class Exercicio3_1 extends HttpServlet {
  ...
  private String Cidades[][] = {{"1","S�o Paulo"},
                                {"2","Rio de Janeiro"},
                                {"3","Espirito Santo"},
                                {"4","Rio Grande do Sul"},
                                {"5","Paran�"},
  ...
  private void fazerpesquisa(HttpServletRequest request, HttpServletResponse response,
    ...
    out.println("<title>An�lise e Desenvolvimento de Sistemas</title>");
    out.println("</head>");
    ...
    out.println("                  An�lise e Desenvolvimento de Sistemas<br>");
    ...
    out.println("                <td width='29%'><div align='right'><font color='#FFFFFF' size='4' face='Verdana, Arial, Helvetica, sans-serif'><strong>3� / 4� ");
    ...
    for(int cont=0;cont<Rotas.length;cont++){
          if (v_origem.equals(Rotas[cont][1])){ // C�digo de origem
             for(int cont2=0;cont2<Cidades.length;cont2++){
                if (Rotas[cont][2].equals(Cidades[cont2][0])){ // C�digo de destino
    ...
    if (vtotcid == 0){
       out.println("<option value=''>N�o existem passagens partindo desta cidade</option>");
    }
    out.println("                    </select></td>");
    out.println("                </tr>");
    out.println("                <tr> ");
   ...
   private void resultado(HttpServletRequest request, HttpServletResponse response,
    ...
    for(int cont=0;cont<Rotas.length;cont++){
          if (Cid_origem.equals(Rotas[cont][1]) && Cid_destino.equals(Rotas[cont][2]) ){ // C�digo de origem  e Destino
    ...
    for(int cont=0;cont<Itinerario.length;cont++){
          if (Cod_Rota.equals(Itinerario[cont][1])){ // Procura a posi��o na matriz do Itinerario
              out.println("<tr> ");
              out.println("<td>&nbsp;</td>");
              for(int cont2=0;cont2<Empresa.length;cont2++){
                    if (Itinerario[cont][2].equals(Empresa[cont2][0])){ // Procura a Empresa de �nibus
              ...
              for(int cont3=0;cont3<TipoOnibus.length;cont3++){
                    if (Itinerario[cont][5].equals(TipoOnibus[cont3][0])){ // Procura o tipo de �nibus
