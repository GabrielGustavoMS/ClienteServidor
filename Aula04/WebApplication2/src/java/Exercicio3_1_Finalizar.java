...
public class Exercicio3_1_Finalizar extends HttpServlet {
    ...
    try {
        ...
        for (int cont1 = 0; cont1 < cookies.length; cont1++) {
            ...
            if (Qtd.equals("")){
                ...
                for(int cont2=0;cont2<Itinerario.length;cont2++){
                    if (Cod_Itinerario.equals(Itinerario[cont2][0])){ // Procura a posi��o na matriz do Itinerario
                        ...
                        for(int cont3=0;cont3<Empresa.length;cont3++){
                              if (Itinerario[cont1][2].equals(Empresa[cont3][0])){ // Procura a Empresa de �nibus
                        ...
                        for(int cont3=0;cont3<TipoOnibus.length;cont3++){
                              if (Itinerario[cont1][5].equals(TipoOnibus[cont3][0])){ // Procura o tipo de �nibus
        ...
        out.println("            <tr> ");
        out.println("              <td colspan='9'><div align='center'><strong><font color='#CC3300' size='6'>N�o Existem Passagens Reservadas </font><font color='#CC3300' size='5'><br>");
        out.println("            </tr>");
        out.println("            <tr>");
        out.println("              <td height='20'>&nbsp;</td>");
        out.println("              <td colspan='8'>&nbsp;</td>");
